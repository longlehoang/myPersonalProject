...
DELETE TEMP_RPT_VN_CoolerWFReport;
...
OR Rank = 2)
INSERT INTO TEMP_RPT_VN_CoolerWFReport
...
FROM source
GROUP BY STARTTIME, TaskHeadID, Code, Name, Address, country, company
, salesOrg, RegionManager, SalesManager, SalesOffice, AreaManager, TerritorySalesManager, Comment

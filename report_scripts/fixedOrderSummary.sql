select	org.country,org.company,org.salesOrg,org.RegionManager,org.SalesManager
	...
	from 
		(select ORDER_date,PURCHASE_ORDER,Additional_info,order_no,OrderType,OrderTarget,USER_ID,customer_id,STATUS, CHAIN_ID
	...
	where isnull(ol.FREE_PRODUCTS,0)<>1 and (oh.STATUS = 6 or ol.OrderLineStatus=2)
	 ...
	 and org.countryID=8 and org.companyID=35 and org.salesOrgID=54 and org.salesOfficeID=80 and oh.CHAIN_ID in (600)

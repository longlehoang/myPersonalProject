with ol as (
		...
		select	oh.customer_id,oh.Confirmed_Date as oh_comfirmed,oh.user_id,oh.chain_id,oh.OrderType,ol.*
				...
				from order_headers oh --  with(index = [IDX_Order_Header_Comfirmed_Date])
					...
					where oh.Confirmed_Date>='Mar 23 2016 12:00AM' 
					and oh.Confirmed_Date<'Mar 24 2016 12:00AM'
		) t 
		left join (
		select	ol.order_no
		--,ol.promotion_id
	 ...
	 and ol.order_no = 'R5411603231357570'
	 --and u.countryID=8 and u.companyID=35 and u.salesOrgID=137
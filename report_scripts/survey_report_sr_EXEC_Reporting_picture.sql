...
,po.salesRep CreatorName,U.Code CreatorCode, 'SR/DSR' CreatorRole
                                                    ...
                                                    ,CCVN4_Reporting.dbo.[GET_OPTIONVALUE](TD.ItemValue) ItemValue
											...
											WHERE TranS.LastUpdate between '10Mar17' and '11Mar17') TS
													...
													LEFT JOIN CCVN4_Reporting.dbo.Customer_Photo CP 

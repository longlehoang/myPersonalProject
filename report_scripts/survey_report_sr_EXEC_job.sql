...
EXEC msdb.dbo.sp_send_dbmail
    ...
    @recipients = 'pknguyen@coca-cola.com.vn; ntnhat@coca-cola.com.vn; ttmha@coca-cola.com.vn; ngpbtan@coca-cola.com.vn',
    @query = 
'SET NOCOUNT ON; 
SELECT * FROM (SELECT convert(varchar, TS.LastUpdate, 120) CreatedDate, po.*,u.Name CreatorName,U.Code CreatorCode, ''SR/DSR'' CreatorRole
											...
											WHERE TranS.LastUpdate > GETDATE() - 1) TS
...
SET NOCOUNT OFF;' ,
    @subject = 'RED survey daily report',
       @body = 
'Hi all,
       
Please see attached report for today
       
Regards,
Minh',
	   @attach_query_result_as_file = 1,
       @query_attachment_filename = 'REDsurveyDaily.csv',
